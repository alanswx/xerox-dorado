// cell_MC10106 -- Triple 4-3-3 Input NOR
//
// Pin numbers and gate grouping: PARC's EclDict.Analyze. Function: Motorola
// MECL Pocket Book (cells/PARTS.md). Used in 12 package position(s).
//
...
module cell_MC10106 (
  ...
  assign p3 = ~(p4 | p5 | p6 | p7);
  assign p2 = ~(p9 | p10 | p11);
  assign p15 = ~(p12 | p13 | p14);
