// cell_SE10210 -- High-Speed Dual 3-Input 3-Output OR (Signetics second source)
//
// Pin numbers and gate grouping: PARC's EclDict.Analyze. Function: Motorola
// MECL Pocket Book (cells/PARTS.md). Used in 162 package position(s).
//
...
module cell_SE10210 (
  ...
  assign p3 = (p5 | p6 | p7);
  assign p4 = (p5 | p6 | p7);
  assign p12 = (p9 | p10 | p11);
  assign p13 = (p9 | p10 | p11);
  assign p14 = (p9 | p10 | p11);

  // Board-wired pins the dictionary does not name (power and the like)
  wire _unused_pins = &{1'b0, p8, p15, p16, 1'b0};
