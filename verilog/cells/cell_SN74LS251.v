...
//
// The '251 is the '151 with a THREE-STATE Y instead of a totem-pole one.
// The enable is not used to share the net on this board -- every instance
// has its own -- so the disabled state is driven low rather than modelled as
// a high-Z an FPGA has no equivalent for inside the fabric.
...
module cell_SN74LS251 (
  ...
  wire [7:0] d    = {p12, p13, p14, p15, p1, p2, p3, p4};  // D7..D0

  assign p5 = ~p7 & d[sel];               // Y
