...
#endif
            VL_FATAL_MT("verilog/verilator/tb_taskrun.sv", 106, "", "NBA region did not converge after 100 tries");
        }
...
#endif
                VL_FATAL_MT("verilog/verilator/tb_taskrun.sv", 106, "", "Active region did not converge after 100 tries");
            }
