...
VlCoroutine Vtb_memrun___024root___eval_initial__TOP__Vtiming__0__0(Vtb_memrun___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(((1U & (~ (IData)(vlSelfRef.tb_memrun__DOT__m__DOT__DisHold___05FMemC)))))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_memrun.sv:1628: Assertion failed in %Ntb_memrun: SetMcr# did not set DisHold -- the memory cycle cannot start\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
        VL_STOP_MT("verilog/verilator/tb_memrun.sv", 1628, "", false);
    }
