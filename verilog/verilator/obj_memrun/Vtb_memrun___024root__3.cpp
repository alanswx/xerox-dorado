...
VlCoroutine Vtb_memrun___024root___eval_initial__TOP__Vtiming__0__4(Vtb_memrun___024root* vlSelf) {
    ...
    if (VL_UNLIKELY((((IData)(vlSelfRef.tb_memrun__DOT__m__DOT__PRhold) 
        ...
        VL_WRITEF_NX("[%0t] %%Fatal: tb_memrun.sv:1445: Assertion failed in %Ntb_memrun: the memory is holding the processor before the machine starts\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
        VL_STOP_MT("verilog/verilator/tb_memrun.sv", 1445, "", false);
    }
    ...
    if (VL_UNLIKELY((VL_GTS_III(32, 0x00000064U, tb_memrun__DOT__nff0)))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_memrun.sv:1592: Assertion failed in %Ntb_memrun: the ASEL=1 reference barely ran (%0d samples) -- it must be the executing instruction\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name(),
                     32,tb_memrun__DOT__nff0);
        VL_STOP_MT("verilog/verilator/tb_memrun.sv", 1592, "", false);
    }
    if (VL_UNLIKELY(((tb_memrun__DOT__nff0_wpr != tb_memrun__DOT__nff0)))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_memrun.sv:1594: Assertion failed in %Ntb_memrun: WantProcRef' was not asserted on every cycle the reference ran (%0d of %0d)\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name(),
                     32,tb_memrun__DOT__nff0_wpr,32,
                     tb_memrun__DOT__nff0);
        VL_STOP_MT("verilog/verilator/tb_memrun.sv", 1594, "", false);
    }
    if (VL_UNLIKELY((((0U != tb_memrun__DOT__nff0_ign) 
                      | (0U != tb_memrun__DOT__nff0_a0))))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_memrun.sv:1597: Assertion failed in %Ntb_memrun: WantProcRef' low requires IgnoreProc = 0 and ASEL.0 = 0 (saw %0d, %0d)\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name(),
                     32,tb_memrun__DOT__nff0_ign,32,
                     tb_memrun__DOT__nff0_a0);
        VL_STOP_MT("verilog/verilator/tb_memrun.sv", 1597, "", false);
    }
    ...
    if (VL_UNLIKELY((VL_GTS_III(32, 2U, tb_memrun__DOT__nras)))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_memrun.sv:1620: Assertion failed in %Ntb_memrun: MemRASa never strobed -- no DRAM cycle started\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
        VL_STOP_MT("verilog/verilator/tb_memrun.sv", 1620, "", false);
    }
    if (VL_UNLIKELY((VL_GTS_III(32, 2U, tb_memrun__DOT__ncas)))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_memrun.sv:1621: Assertion failed in %Ntb_memrun: MemCASa never strobed -- the cycle did not get past RAS\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
        VL_STOP_MT("verilog/verilator/tb_memrun.sv", 1621, "", false);
    }
    if (VL_UNLIKELY((VL_GTS_III(32, 2U, tb_memrun__DOT__nms)))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_memrun.sv:1622: Assertion failed in %Ntb_memrun: MapState never advanced -- the PROM sequencer is not running\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
        VL_STOP_MT("verilog/verilator/tb_memrun.sv", 1622, "", false);
    }
    ...
    if (VL_UNLIKELY((vlSelfRef.tb_memrun__DOT__m__DOT__PRhold))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_memrun.sv:1693: Assertion failed in %Ntb_memrun: the memory is still holding the processor after a run\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
    ...
    if (VL_UNLIKELY((VL_GTS_III(32, 0x00000064U, tb_memrun__DOT__n0a)))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_memrun.sv:1695: Assertion failed in %Ntb_memrun: the microinstruction clock is not free-running\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
        VL_STOP_MT("verilog/verilator/tb_memrun.sv", 1695, "", false);
    }
    ...
    if (VL_UNLIKELY(((0U != tb_memrun__DOT__tbad)))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_memrun.sv:1784: Assertion failed in %Ntb_memrun: the memory section is not right in a running machine\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
    ...
    VL_FINISH_MT("verilog/verilator/tb_memrun.sv", 1786, "");
    co_return;}
