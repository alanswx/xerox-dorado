...
VlCoroutine Vtb_readback___024root___eval_initial__TOP__Vtiming__0__5(Vtb_readback___024root* vlSelf) {
    ...
    VL_WRITEF_NX("tb_readback: READ PATH -- '166 load edges %0d | q at load = %b (want %b) | QH=%b | Sin.00 high on %0d, SinD.00 high on %0d\n",0,
                 32,vlSelfRef.tb_readback__DOT__n_load_edge_rb,
                 8,(IData)(vlSelfRef.tb_readback__DOT__q_at_load),
                 8,vlSelfRef.tb_readback__DOT__want_pat,
    ...
    if (VL_UNLIKELY(((0U == vlSelfRef.tb_readback__DOT__n_load_edge_rb)))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_readback.sv:3253: Assertion failed in %Ntb_readback: the '166s were never loaded -- no read reached the storage array\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
        VL_STOP_MT("verilog/verilator/tb_readback.sv", 3253, "", false);
    }
    if (VL_UNLIKELY((((IData)(vlSelfRef.tb_readback__DOT__q_at_load) 
                      != (IData)(vlSelfRef.tb_readback__DOT__want_pat))))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_readback.sv:3255: Assertion failed in %Ntb_readback: the array did not return the seeded word (got %b, want %b)\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name(),
                     8,(IData)(vlSelfRef.tb_readback__DOT__q_at_load),
                     8,vlSelfRef.tb_readback__DOT__want_pat);
        VL_STOP_MT("verilog/verilator/tb_readback.sv", 3255, "", false);
    }
    if (VL_UNLIKELY((((IData)(vlSelfRef.tb_readback__DOT__qh_at_load) 
                      != (1U & ((IData)(vlSelfRef.tb_readback__DOT__want_pat) 
                                >> 7U)))))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_readback.sv:3258: Assertion failed in %Ntb_readback: QH is not the H stage at load (QH=%b, H=%b)\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name(),
                     1,(IData)(vlSelfRef.tb_readback__DOT__qh_at_load),
                     1,(1U & ((IData)(vlSelfRef.tb_readback__DOT__want_pat) 
                              >> 7U)));
        VL_STOP_MT("verilog/verilator/tb_readback.sv", 3258, "", false);
    }
    if (VL_UNLIKELY(((0U == vlSelfRef.tb_readback__DOT__n_sin_hi)))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_readback.sv:3260: Assertion failed in %Ntb_readback: Sin.00 never went high -- the word never left the storage board\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
        VL_STOP_MT("verilog/verilator/tb_readback.sv", 3260, "", false);
    }
    ...
    VL_WRITEF_NX("tb_readback:   a03 CONTENTS at the four filled rows -- [3072]=%b [3073]=%b [3074]=%b [3075]=%b (d03: %b %b %b %b)\ntb_readback:   BANKS -- D0 (a03): WE' falls %0d carrying a 1 %0d, CE' low %0d | D1 (d03): WE' falls %0d carrying a 1 %0d, CE' low %0d\ntb_readback:   FILL ADDRESS -- last write %b, last write CARRYING A ONE %b (%0d such), last read %b\ntb_readback:   RETURN WORD (cache seeded 001100101101001101) -- dMD=%b matched on %0d | Md=%b matched on %0d\n",0,
                 1,vlSelfRef.tb_readback__DOT__m__DOT__b_MemD__DOT__u_a03__DOT__mem
                 [0x0c00U],1,vlSelfRef.tb_readback__DOT__m__DOT__b_MemD__DOT__u_a03__DOT__mem
                 [0x0c01U],1,vlSelfRef.tb_readback__DOT__m__DOT__b_MemD__DOT__u_a03__DOT__mem
                 [0x0c02U],1,vlSelfRef.tb_readback__DOT__m__DOT__b_MemD__DOT__u_a03__DOT__mem
                 [0x0c03U],1,vlSelfRef.tb_readback__DOT__m__DOT__b_MemD__DOT__u_d03__DOT__mem
                 [0x0c00U],1,vlSelfRef.tb_readback__DOT__m__DOT__b_MemD__DOT__u_d03__DOT__mem
                 [0x0c01U],1,vlSelfRef.tb_readback__DOT__m__DOT__b_MemD__DOT__u_d03__DOT__mem
                 [0x0c02U],1,vlSelfRef.tb_readback__DOT__m__DOT__b_MemD__DOT__u_d03__DOT__mem
                 [0x0c03U],32,vlSelfRef.tb_readback__DOT__n_we_fall,
                 32,vlSelfRef.tb_readback__DOT__n_we_ones,
                 32,vlSelfRef.tb_readback__DOT__n_ce0,
                 32,vlSelfRef.tb_readback__DOT__n_we1,
                 32,vlSelfRef.tb_readback__DOT__n_we1_ones,
                 32,vlSelfRef.tb_readback__DOT__n_ce1,
                 12,(IData)(vlSelfRef.tb_readback__DOT__dad_at_write),
                 12,vlSelfRef.tb_readback__DOT__dad_ones,
                 32,vlSelfRef.tb_readback__DOT__n_we_ones,
    ...
    if (VL_UNLIKELY(((0U == vlSelfRef.tb_readback__DOT__n_mdd)))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_readback.sv:3293: Assertion failed in %Ntb_readback: MD_D never asserted -- the cache was never selected as the MD source\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
        VL_STOP_MT("verilog/verilator/tb_readback.sv", 3293, "", false);
    }
    if (VL_UNLIKELY(((0U == vlSelfRef.tb_readback__DOT__n_dmd16)))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_readback.sv:3295: Assertion failed in %Ntb_readback: the seeded cache word never reached dMD (last dMD=%b, want 001100101101001101)\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name(),
                     18,vlSelfRef.tb_readback__DOT__dmd_cap);
        VL_STOP_MT("verilog/verilator/tb_readback.sv", 3295, "", false);
    }
    if (VL_UNLIKELY(((0U == vlSelfRef.tb_readback__DOT__n_md16)))) {
        VL_WRITEF_NX("[%0t] %%Fatal: tb_readback.sv:3298: Assertion failed in %Ntb_readback: the seeded cache word never reached Md on the processor (last Md=%b, want 001100101101001101)\n",0,
                     64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name(),
                     18,vlSelfRef.tb_readback__DOT__md_cap);
        VL_STOP_MT("verilog/verilator/tb_readback.sv", 3298, "", false);
    }
    ...
    VL_FINISH_MT("verilog/verilator/tb_readback.sv", 3308, "");
    co_return;}
