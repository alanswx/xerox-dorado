    ...
    if (vlSelfRef.tb_ifu__DOT__m__DOT__b_MemD__DOT__u_i21__DOT__p12) {
        ...
        if ((1U & (~ (IData)(vlSelfRef.tb_ifu__DOT__m__DOT__GLd_p___05F_IFU)))) {
            vlSelfRef.tb_ifu__DOT__m__DOT__b_MemD__DOT__u_i21__DOT__q 
                = ((((IData)(vlSelfRef.tb_ifu__DOT__m__DOT__b_MemD__DOT__u_i21__DOT__p7) 
                     << 3U) | ((IData)(vlSelfRef.tb_ifu__DOT__m__DOT__b_MemD__DOT__u_i21__DOT__p9) 
                               << 2U)) | (((IData)(vlSelfRef.tb_ifu__DOT__m__DOT__b_MemD__DOT__F_17) 
                                           << 1U) | (IData)(vlSelfRef.tb_ifu__DOT__m__DOT__b_MemD__DOT__F_16)));
        }
    }
