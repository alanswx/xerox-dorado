...
module dorado_boot #(parameter integer SYSPER = 16) (
  ...
  assign DMuxData = DMuxData__BaseBd | DMuxData__ContA | DMuxData__ContB | DMuxData__ProcH | DMuxData__ProcL;
  ...
  wire DMuxData__rd_ProcH = DMuxData__BaseBd | DMuxData__ContA | DMuxData__ContB | DMuxData__ProcL;
...
// dorado_boot_machine -- the machine with its external connections resolved, so
...
module dorado_boot_machine #(parameter integer SYSPER = 16) (
  ...
  // The clock fanout, read out of the machine: 4 nets,
