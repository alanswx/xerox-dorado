...
//
// Configuration: ContA ContB ProcH ProcL MemC MemD MemX msa IFU DispY DskEth
// 533 internal nets (81 with several contributors), 280 top-level ports.

`default_nettype none

module dorado_full #(parameter integer SYSPER = 16) (
    ...
    input  wire IOReset                   ,  // awaits BaseBd DispM IOTest Music
    ...
    input  wire Pendulum                  ,  // awaits BaseBd
    ...
    input  wire TempRef                   ,  // awaits BaseBd
  ...
  // 533 nets between boards, plus one contribution wire
  // per driving board.
  wire ALUCarry;
  wire ALUF_0;
  wire ALUF_1;
  ...
  assign DMuxData = DMuxData__ContA | DMuxData__ContB | DMuxData__DispY | DMuxData__DskEth | DMuxData__IFU | DMuxData__MemC | DMuxData__MemD | DMuxData__MemX | DMuxData__ProcH | DMuxData__ProcL;
  ...
  wire DMuxData__rd_ProcH = DMuxData__ContA | DMuxData__ContB | DMuxData__DispY | DMuxData__DskEth | DMuxData__IFU | DMuxData__MemC | DMuxData__MemD | DMuxData__MemX | DMuxData__ProcL;
...
// dorado_full_machine -- the machine with its external connections resolved, so
...
//
// probe_val exposes 156 signals, 32 at a time;
// dorado_full.probes lists which bit is which.
module dorado_full_machine #(parameter integer SYSPER = 16) (
    input  wire        sys_clk,
  ...
  dorado_full #(.SYSPER(SYSPER)) u_machine (
    .sys_clk(sys_clk),
    .n_24Bit(n_24Bit),
    .A8B2(A8B2),
    .AItem_0(AItem_0),
