...
// 484 internal nets (48 with several contributors), 215 top-level ports.

`default_nettype none

module dorado_display #(parameter integer SYSPER = 16) (
    ...
    input  wire CLK_display_p_            ,  // awaits BaseBd
    ...
    input  wire IOReset                   ,  // awaits BaseBd DispM DskEth IFU IOTest Music
  ...
  // 484 nets between boards, plus one contribution wire
  // per driving board.
  wire ALUCarry;
  wire ALUF_0;
  wire ALUF_1;
  ...
  assign DMuxData = DMuxData__ContA | DMuxData__ContB | DMuxData__DispY | DMuxData__MemC | DMuxData__MemD | DMuxData__MemX | DMuxData__ProcH | DMuxData__ProcL;
  ...
  assign IOB_00 = IOB_00__DispY | IOB_00__ProcH;
  ...
  assign IOB_15 = IOB_15__DispY | IOB_15__ProcL;
  assign IOB_16 = IOB_16__DispY | IOB_16__ProcH;
  assign IOB_17 = IOB_17__DispY | IOB_17__ProcL;
  ...
  wire DMuxData__rd_ProcH = DMuxData__ContA | DMuxData__ContB | DMuxData__DispY | DMuxData__MemC | DMuxData__MemD | DMuxData__MemX | DMuxData__ProcL;
...
// dorado_display_machine -- the machine with its external connections resolved, so
...
//
// probe_val exposes 108 signals, 32 at a time;
...
module dorado_display_machine #(parameter integer SYSPER = 16) (
  ...
  dorado_display #(.SYSPER(SYSPER)) u_machine (
    .sys_clk(sys_clk),
    .n_24Bit(n_24Bit),
    .A8B2(A8B2),
    .AItem_0(AItem_0),
