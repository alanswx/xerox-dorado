...
// 429 internal nets (44 with several contributors), 213 top-level ports.
...
module dorado_storage #(parameter integer SYSPER = 16) (
    ...
    input  wire CLK_mc_p_                 ,  // awaits BaseBd
    input  wire CLK_md_p_                 ,  // awaits BaseBd
    input  wire CLK_ms0Even_p_            ,  // awaits BaseBd PCMSA
    input  wire CLK_mx_p_                 ,  // awaits BaseBd
    ...
    input  wire EnableFG_p_               ,  // awaits IFU
    ...
    output wire FG_0                      ,  // awaits IFU
    output wire FG_1                      ,  // awaits IFU
    output wire FG_2                      ,  // awaits IFU
    output wire FG_3                      ,  // awaits IFU
    output wire FG_4                      ,  // awaits IFU
    output wire FG_5                      ,  // awaits IFU
    output wire FG_6                      ,  // awaits IFU
    output wire FG_7                      ,  // awaits IFU
    output wire FG_8                      ,  // awaits IFU
    ...
    output wire Fout_00                   ,  // awaits DispM DispY IOTest
    output wire Fout_01                   ,  // awaits DispM DispY IOTest
    output wire Fout_02                   ,  // awaits DispM DispY IOTest
    output wire Fout_03                   ,  // awaits DispM DispY IOTest
    output wire Fout_04                   ,  // awaits DispM DispY IOTest
    output wire Fout_05                   ,  // awaits DispM DispY IOTest
    output wire Fout_06                   ,  // awaits DispM DispY IOTest
    output wire Fout_07                   ,  // awaits DispM DispY IOTest
    output wire Fout_08                   ,  // awaits DispM DispY IOTest
    output wire Fout_09                   ,  // awaits DispM DispY IOTest
    output wire Fout_10                   ,  // awaits DispM DispY IOTest
    output wire Fout_11                   ,  // awaits DispM DispY IOTest
    output wire Fout_12                   ,  // awaits DispM DispY IOTest
    output wire Fout_13                   ,  // awaits DispM DispY IOTest
    output wire Fout_14                   ,  // awaits DispM DispY IOTest
    output wire Fout_15                   ,  // awaits DispM DispY IOTest
    output wire Fout_16                   ,  // awaits IOTest
    output wire Fout_17                   ,  // awaits IOTest
    output wire Fout_flt                  ,  // to a backplane connector (cable)
    output wire FoutNext                  ,  // awaits DispM DispY IOTest
    output wire FoutSubTask_0             ,  // awaits DispY IOTest
    output wire FoutSubtask_1             ,  // awaits IOTest
    output wire FoutTask_0                ,  // awaits DispM DispY IOTest
    output wire FoutTask_1                ,  // awaits DispM DispY IOTest
    output wire FoutTask_2                ,  // awaits DispM DispY IOTest
    output wire FoutTask_3                ,  // awaits DispM DispY IOTest
    input  wire GDv_p_                    ,  // awaits IFU
    input  wire GLd_p_                    ,  // awaits IFU
    ...
    input  wire IfuData_0                 ,  // awaits IFU
    input  wire IfuData_1                 ,  // awaits IFU
    input  wire IfuData_2                 ,  // awaits IFU
    input  wire IfuData_3                 ,  // awaits IFU
    input  wire IfuData_4                 ,  // awaits IFU
    input  wire IfuData_5                 ,  // awaits IFU
    input  wire IfuData_6                 ,  // awaits IFU
    input  wire IfuData_7                 ,  // awaits IFU
    output wire IfuFaultInEc2             ,  // awaits IFU
    output wire IfuHold                   ,  // awaits IFU
  ...
  // 429 nets between boards, plus one contribution wire
  // per driving board.
  wire ALUCarry;
  wire ALUF_0;
  wire ALUF_1;
  ...
  assign BMux_00 = BMux_00__ContA | BMux_00__MemC | BMux_00__MemD | BMux_00__MemX | BMux_00__ProcH;
  assign BMux_01 = BMux_01__ContA | BMux_01__MemC | BMux_01__MemD | BMux_01__MemX | BMux_01__ProcH;
  assign BMux_02 = BMux_02__ContA | BMux_02__MemC | BMux_02__MemD | BMux_02__MemX | BMux_02__ProcH;
  assign BMux_03 = BMux_03__ContA | BMux_03__MemC | BMux_03__MemD | BMux_03__MemX | BMux_03__ProcH;
  assign BMux_04 = BMux_04__ContA | BMux_04__MemC | BMux_04__MemD | BMux_04__MemX | BMux_04__ProcH;
  assign BMux_05 = BMux_05__ContA | BMux_05__MemC | BMux_05__MemD | BMux_05__MemX | BMux_05__ProcH;
  assign BMux_06 = BMux_06__ContA | BMux_06__MemC | BMux_06__MemD | BMux_06__MemX | BMux_06__ProcH;
  assign BMux_07 = BMux_07__ContA | BMux_07__MemC | BMux_07__MemD | BMux_07__MemX | BMux_07__ProcH;
  assign BMux_08 = BMux_08__ContA | BMux_08__MemC | BMux_08__MemD | BMux_08__MemX | BMux_08__ProcL;
  assign BMux_09 = BMux_09__ContA | BMux_09__MemC | BMux_09__MemD | BMux_09__MemX | BMux_09__ProcL;
  assign BMux_10 = BMux_10__ContA | BMux_10__MemC | BMux_10__MemD | BMux_10__MemX | BMux_10__ProcL;
  assign BMux_11 = BMux_11__ContA | BMux_11__MemC | BMux_11__MemD | BMux_11__MemX | BMux_11__ProcL;
  assign BMux_12 = BMux_12__ContA | BMux_12__MemC | BMux_12__MemD | BMux_12__MemX | BMux_12__ProcL;
  assign BMux_13 = BMux_13__ContA | BMux_13__MemC | BMux_13__MemD | BMux_13__MemX | BMux_13__ProcL;
  assign BMux_14 = BMux_14__ContA | BMux_14__MemC | BMux_14__MemD | BMux_14__MemX | BMux_14__ProcL;
  assign BMux_15 = BMux_15__ContA | BMux_15__MemC | BMux_15__MemD | BMux_15__MemX | BMux_15__ProcL;
  ...
  assign DMuxData = DMuxData__ContA | DMuxData__ContB | DMuxData__MemC | DMuxData__MemD | DMuxData__MemX | DMuxData__ProcH | DMuxData__ProcL;
  ...
  assign IfuAck = IfuAck__MemC;
  assign IfuFaultInEc2 = IfuFaultInEc2__MemX;
  ...
  wire DMuxData__rd_ProcH = DMuxData__ContA | DMuxData__ContB | DMuxData__MemC | DMuxData__MemD | DMuxData__MemX | DMuxData__ProcL;
...
// dorado_storage_machine -- the machine with its external connections resolved, so
