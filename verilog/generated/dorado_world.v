...
// 475 internal nets (62 with several contributors), 211 top-level ports.

`default_nettype none

module dorado_world #(parameter integer SYSPER = 16) (
    ...
    input  wire CLK_ifu_p_                ,  // awaits BaseBd
    ...
    input  wire IOReset                   ,  // awaits BaseBd DispM DispY DskEth IOTest Music
    ...
    input  wire Pendulum                  ,  // awaits BaseBd DskEth
    ...
    input  wire TempRef                   ,  // awaits BaseBd DskEth
    output wire TestTW                       // to a backplane connector (cable)
);

  // 475 nets between boards, plus one contribution wire
  // per driving board.
  wire ALUCarry;
  wire ALUF_0;
  wire ALUF_1;
  ...
  assign DMuxData = DMuxData__ContA | DMuxData__ContB | DMuxData__IFU | DMuxData__MemC | DMuxData__MemD | DMuxData__MemX | DMuxData__ProcH | DMuxData__ProcL;
...
// dorado_world_machine -- the machine with its external connections resolved, so
