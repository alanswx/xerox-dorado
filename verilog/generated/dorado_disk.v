...
// 461 internal nets (63 with several contributors), 255 top-level ports.

`default_nettype none

module dorado_disk #(parameter integer SYSPER = 16) (
    ...
    input  wire CLK_disk_p_               ,  // awaits BaseBd
    ...
    input  wire IOReset                   ,  // awaits BaseBd DispM DispY IFU IOTest Music
    ...
    input  wire Pendulum                  ,  // awaits BaseBd IFU
    output wire RScopeClk0_p_             ,  // to a backplane connector (cable)
    input  wire RcvData                   ,  // awaits BaseBd
  ...
  // 461 nets between boards, plus one contribution wire
  // per driving board.
  wire ALUCarry;
  wire ALUF_0;
  wire ALUF_1;
  ...
  assign DMuxData = DMuxData__ContA | DMuxData__ContB | DMuxData__DskEth | DMuxData__MemC | DMuxData__MemD | DMuxData__MemX | DMuxData__ProcH | DMuxData__ProcL;
  ...
  assign IOB_00 = IOB_00__DskEth | IOB_00__ProcH;
  ...
  assign IOB_15 = IOB_15__DskEth | IOB_15__ProcL;
  assign IOB_16 = IOB_16__DskEth | IOB_16__ProcH;
  assign IOB_17 = IOB_17__DskEth | IOB_17__ProcL;
  ...
  wire DMuxData__rd_ProcH = DMuxData__ContA | DMuxData__ContB | DMuxData__DskEth | DMuxData__MemC | DMuxData__MemD | DMuxData__MemX | DMuxData__ProcL;
...
// dorado_disk_machine -- the machine with its external connections resolved, so
...
module dorado_disk_machine #(parameter integer SYSPER = 16) (
  ...
  dorado_disk #(.SYSPER(SYSPER)) u_machine (
    .sys_clk(sys_clk),
    .CBTempSense(CBTempSense),
    .CLK_ca_p_(1'b0),
    .CLK_cb_p_(1'b0),
