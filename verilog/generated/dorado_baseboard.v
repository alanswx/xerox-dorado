...
module dorado_baseboard #(parameter integer SYSPER = 16) (
...
module dorado_baseboard_machine #(parameter integer SYSPER = 16) (
    input  wire        sys_clk,
  ...
  dorado_baseboard #(.SYSPER(SYSPER)) u_machine (
    .sys_clk(sys_clk),
    .ACPABus_0_p_(1'b0),
    .ACPABus_1_p_(1'b0),
    .ACPABus_2_p_(1'b0),
