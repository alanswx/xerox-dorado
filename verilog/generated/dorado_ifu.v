...
// 418 internal nets (62 with several contributors), 264 top-level ports.

`default_nettype none

module dorado_ifu #(parameter integer SYSPER = 16) (
  ...
  // 418 nets between boards, plus one contribution wire
  // per driving board.
  wire ALUCarry;
  wire ALUF_0;
  wire ALUF_1;
...
// dorado_ifu_machine -- the machine with its external connections resolved, so
...
module dorado_ifu_machine #(parameter integer SYSPER = 16) (
  ...
  dorado_ifu #(.SYSPER(SYSPER)) u_machine (
    .sys_clk(sys_clk),
