...
| **...AND WORDS REACH THE FIFO, WHICH A DISKDATA READ POPS** | `disk-format-test` -- `InRegFull` 4 words, `FifoWaddr` 0011->0111, and `Pd<-Input` at 012B advances `FifoRaddr` 0001->0010 (`DskData`'s CONTENTS still open) |
