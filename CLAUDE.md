...
| **THE MONOCHROME DISPLAY BOARD IS IN A MACHINE AND ASKING** | `display-test` -- nine boards; DispY clocked, its HEAD task reaching ContA, its WORD task's condition proven, and its slow-I/O address decoding to 37B alone |
